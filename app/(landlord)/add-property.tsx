// ========================================
// FILE: app/(landlord)/add-property.tsx
// Add Property - StayIN Branded Gradient Header
// ========================================
...
export default function AddPropertyScreen() {
  ...
  const [form, setForm] = useState({
    ...
    amenities: [] as string[],
    images: [] as string[],
    latitude: -15.3875, // Default Lusaka coords
    longitude: 28.3228,
  });
  ...
  const pickImages = async () => {
    ...
    if (!result.canceled) {
      ...
      setForm((prev) => ({
        ...prev,
        images: [...prev.images, ...newImages].slice(0, 10), // max 10
      }));
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await LandlordService.addProperty(user!.id, {
        ...form,
